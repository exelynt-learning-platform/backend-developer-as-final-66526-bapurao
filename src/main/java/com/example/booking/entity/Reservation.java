...
@Entity @Table(name="reservations", indexes={@Index(name="idx_reservation_resource_time",columnList="resource_id,start_time,end_time"),@Index(name="idx_reservation_user",columnList="user_id")})
